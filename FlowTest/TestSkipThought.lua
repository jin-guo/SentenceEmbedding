...
local vocab = sentenceembedding.Vocab(sentenceembedding.data_dir..'PTC/PTC_Vocab.txt')
...
local corpus={}
corpus = sentenceembedding.read_corpus(sentenceembedding.data_dir..'PTC/', vocab)
print('# of sentences in corpus:' .. #corpus.sentences)


-- Create dataset from the corpus
local dataset = {}
dataset = sentenceembedding.read_skipthough_dataset(sentenceembedding.data_dir..'PTC/')
